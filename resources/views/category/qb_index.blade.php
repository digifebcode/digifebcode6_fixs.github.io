...
<head>
    <meta charset="UTF-8">
    <title>CRUDDD Kategori - Query Builder</title>
...
<body>
    <div class="container mt-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2>CRUD Kategori (Teknik Query Builder)</h2>
            <div>
                <a href="{{ url()->current() }}" class="btn btn-secondary">Refresh Halaman</a>
                <a href="{{ route('raw-category.index') }}" class="btn btn-primary">Pindah ke Raw SQL</a>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="card card-body shadow-sm">
                    ...
                    <form action="{{ route('qb-category.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('qb-category.destroy', $item->id) }}" method="POST" class="d-inline">
                                        @csrf @method('DELETE')
                            ...
                            <div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="{{ route('qb-category.update', $item->id) }}" method="POST">
                                            @csrf @method('PUT')
